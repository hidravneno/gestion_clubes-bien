"""
Django settings for gestion_clubes project.
...
SECRET_KEY = 'django-insecure-uu@9$oy50c$ca5(&1dqjs1ls&e_o018i)jl^=*3de##mx6!=%+'
...
ROOT_URLCONF = 'gestion_clubes.urls'
...
WSGI_APPLICATION = 'gestion_clubes.wsgi.application'
...
DATABASES = {
    'default': dj_database_url.config(default='sqlite:///db.sqlite3')  # Usa SQLite como predeterminado
}
